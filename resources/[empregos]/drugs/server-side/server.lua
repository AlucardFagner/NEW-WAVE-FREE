...
-----------------------------------------------------------------------------------------------------------------------------------------
local itemList = {
	{ item = "lean", priceMin = 450, priceMax = 500, randMin = 5, randMax = 10 },
	{ item = "ecstasy", priceMin = 350, priceMax = 400, randMin = 5, randMax = 10 },
	{ item = "cocaine", priceMin = 450, priceMax = 500, randMin = 5, randMax = 10 },
	{ item = "meth", priceMin = 350, priceMax = 400, randMin = 5, randMax = 10 },
	{ item = "joint", priceMin = 450, priceMax = 500, randMin = 5, randMax = 10 },
	{ item = "oxy", priceMin = 350, priceMax = 400, randMin = 5, randMax = 10 },
	{ item = "heroine", priceMin = 450, priceMax = 500, randMin = 5, randMax = 10}
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECKAMOUNT
-----------------------------------------------------------------------------------------------------------------------------------------
