...
-----------------------------------------------------------------------------------------------------------------------------------------
local craftList = {
	["salierisShop"] = {    --- essa fação é algo pra adm ou para competir com o fliperarama
		["perm"] = "Salieris",
		["list"] = {
			["nails"] = {
				["amount"] = 25,
	...
	["vinhedoShop"] = {         ---- essa facção não é pra usar só no futuro caso precise de uma terceira vendedora de arma na city  
		["perm"] = "vinhedoShop",
		["list"] = {
			["WEAPON_APPISTOL"] = {
				["amount"] = 1,
