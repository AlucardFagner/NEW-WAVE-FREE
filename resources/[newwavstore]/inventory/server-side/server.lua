...
local lootItens = {
	["Medic"] = {
		...
		["cooldown"] = 7200,
		["list"] = {
			[1] = { ["item"] = "alcohol", ["min"] = 10, ["max"] = 15 },
			[2] = { ["item"] = "syringe", ["min"] = 10, ["max"] = 15 },
			[3] = { ["item"] = "codeine", ["min"] = 10, ["max"] = 15 },
			[4] = { ["item"] = "amphetamine", ["min"] = 10, ["max"] = 15 },
			[5] = { ["item"] = "acetone", ["min"] = 10, ["max"] = 15 },
			[6] = { ["item"] = "adrenaline", ["min"] = 1, ["max"] = 3 },
			[7] = { ["item"] = "cotton",["min"] = 10, ["max"] = 15 },
			[8] = { ["item"] = "plaster", ["min"] = 10, ["max"] = 15 },
			[9] = { ["item"] = "saline", ["min"] = 10, ["max"] = 15 },
			[10] = { ["item"] = "sulfuric",["min"] = 10, ["max"] = 15 }
		}
	},
	...
	["Weapons"] = {
		...
		["cooldown"] = 3600,
		["list"] = {
			[1] = { ["item"] = "roadsigns", ["min"] = 10, ["max"] = 15 },
			[2] = { ["item"] = "techtrash", ["min"] = 10, ["max"] = 15 },
			[3] = { ["item"] = "pistolbody", ["min"] = 10, ["max"] = 15 },
			[4] = { ["item"] = "smgbody", ["min"] = 10, ["max"] = 15 },
			[5] = { ["item"] = "riflebody", ["min"] = 10, ["max"] = 15 },
			[6] = { ["item"] = "sheetmetal", ["min"] = 10, ["max"] = 15 },
			[7] = { ["item"] = "explosives", ["min"] = 10, ["max"] = 15 },
			[8] = { ["item"] = "aluminum", ["min"] = 10, ["max"] = 15 },
			[9] = { ["item"] = "copper", ["min"] = 10, ["max"] = 15 },
			[10] = { ["item"] = "nails", ["min"] = 1, ["max"] = 4 }
		}
	},
	["Supplies"] = {
		["null"] = 100,
		["cooldown"] = 3600,
		["list"] = {
			[1] = { ["item"] = "tarp", ["min"] = 10, ["max"] = 15 },
			[2] = { ["item"] = "graphite01", ["min"] = 10, ["max"] = 15 },
			[3] = { ["item"] = "graphite02", ["min"] = 10, ["max"] = 15 },
			[4] = { ["item"] = "leather", ["min"] = 10, ["max"] = 15 },
			[5] = { ["item"] = "animalfat", ["min"] = 10, ["max"] = 15 },
			-- [6] = { ["item"] = "cotton", ["min"] = 10, ["max"] = 15 },
			-- [7] = { ["item"] = "plaster", ["min"] = 10, ["max"] = 15 },
			-- [8] = { ["item"] = "sulfuric", ["min"] = 10, ["max"] = 15 },
			-- [9] = { ["item"] = "saline", ["min"] = 10, ["max"] = 15 },
			-- [10] = { ["item"] = "alcohol", ["min"] = 10, ["max"] = 15 },
			-- [11] = { ["item"] = "syringe", ["min"] = 10, ["max"] = 15 },
			-- [12] = { ["item"] = "card01", ["min"] = 10, ["max"] = 15 },
			[13] = { ["item"] = "weedseed", ["min"] = 10, ["max"] = 15 },
			[14] = { ["item"] = "cokeseed", ["min"] = 10, ["max"] = 15 },
			[15] = { ["item"] = "mushseed", ["min"] = 10, ["max"] = 15 },
			-- [16] = { ["item"] = "heroine", ["min"] = 5, ["max"] = 10 },
			[17] = { ["item"] = "silk", ["min"] = 10, ["max"] = 15 },
			[18] = { ["item"] = "fertilizer", ["min"] = 10, ["max"] = 15 }
		}
	}
}
-----------------------------------------------------------------------------------------------------------------------------------------
		...
		if itemType(totalName) == "Usável" or itemType(totalName) == "Animal" then
			...
			if nameItem == "fidentity" then
				if openIdentity[user_id] then
					...
					if identity then
						openIdentity[user_id] = true
						TriggerClientEvent("vRP:Identity",source,{ mode = "fidentity", nome = identity["name"].." "..identity["name2"], nacionalidade = identity["locate"], porte = identity["port"], passaporte = identity["id"], sangue = bloodTypes(identity["blood"]) })
					end
				end
			return end
				...
				if openIdentity[user_id] then
					...
					if identity then
						...
						if numberIdentity == user_id then
							...
							TriggerClientEvent("vRP:Identity",source,{ mode = "identity", nome = identity["name"].." "..identity["name2"], nacionalidade = identity["locate"], veiculos = identity["garage"], gemas = vRP.userGemstone(identity["discord"]), porte = identity["port"], passaporte = identity["id"], premium = premium, sangue = bloodTypes(identity["blood"]) })
						else
							TriggerClientEvent("vRP:Identity",source,{ mode = "fidentity", nome = identity["name"].." "..identity["name2"], nacionalidade = identity["locate"], porte = identity["port"], passaporte = identity["id"], sangue = bloodTypes(identity["blood"]) })
						end
					end
