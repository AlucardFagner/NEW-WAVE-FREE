...
window.addEventListener("load", () => {
    ...
    playingSong();
    setVolume();
    // console.info("Obrigado por usar minha tela de carregamento junte -se à discórdia, por favor :(")
});
...
// Video
document.getElementById("YTvdo").setAttribute("src", "https://www.youtube.com/embed/" + video_ID + "?autoplay=1&controls=0&playlist="+ video_ID + "&hd=1&amp;&loop=1&mute=1&rel=0&wmode=transparent" + " " + "frameborder='1' allow='autoplay; encrypted-media' allowfullscreen");
document.getElementById("YTvdo").setAttribute("style", "width:100%; height:100%;");
