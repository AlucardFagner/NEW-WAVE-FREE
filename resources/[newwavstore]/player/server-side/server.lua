...
function cRP.receiveSalary()
	...
	if user_id then
		...
		if vRP.hasGroup(user_id,"Emergency") then
			TriggerEvent("vRP:updateSalary",user_id,4000)
			TriggerClientEvent("Notify",source,"azul","Salário de <b>$4.000</b> recebido.",5000)
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
...
local preset = {
	["1"] = {
		["mp_m_freemode_01"] = { 
			["hat"] = { item = 13, texture = 0 },  -- Chapeu
			["pants"] = { item = 130, texture = 1 },  -- Calças
			["vest"] = { item = 0, texture = 0 },  -- Colete
			["bracelet"] = { item = -1, texture = 0 }, -- Bracelete
			["decals"] = { item = 78, texture = 0 }, --- Adesivos
			["mask"] = { item = 121, texture = 0 },  -- Mascara
			["shoes"] = { item = 25, texture = 0 },  -- Sapatos
			["tshirt"] = { item = 153, texture = 0 }, -- Camisa
			["torso"] = { item = 318, texture = 4 },  -- Jaqueta
			["accessory"] = { item = 14, texture = 0 }, -- Acessorio
			["watch"] = { item = -1, texture = 0 },  --  Relogio
			["arms"] = { item = 37, texture = 0 },  -- Mãos
			["glass"] = { item = -1, texture = 0 }, -- Oculos
			["ear"] = { item = -1, texture = 0 }  -- Brigo
		},
		["mp_f_freemode_01"] = {
	...
	["2"] = {
		["mp_m_freemode_01"] = {
			["hat"] = { item = 9, texture = 0 },
			["pants"] = { item = 130, texture = 3 },
...
local discordLinks = {
	...
	["Badges"] = "",
	["Vanilla"] = "",
	["Bloods"] = "https://discord.com/api/webhooks/1141325083252637726/8o3n6Apu8mSF6odnMPxecP6oiR8CBi0tueJIgFKekajWBQJcQj9VVUWBe5FyrGsE0mOB",
	["Item"] = "https://discord.com/api/webhooks/1045823154754437180/ZJe8r3Fv2pfzjPNWRLEykKl8cPnPG-NLUSeJT2ErT0YeAfjO23L4d9SaFsvWqTG6GR4S",
	["nc"] = "https://discord.com/api/webhooks/1045823331758252082/IlLWVYWx58ftqxiodm5ybt-v4EDBd6yuw2bkh0s8z8ByHqJ2uVhK1M_eQ7ZkhoPSVwof",
	["Desmanche"] = "https://discord.com/api/webhooks/1189286092831199263/bYUVPY_SSDXgK-Mmly1pkfmnEOW6-i4Yj_Tpio2Mes9GW3mGljW6AGcQ8xPw1R4_0Gv4"
...
function cRP.bikesBackpack()
	...
	if user_id then
		...
		if parseInt(myWeight) < 45 then
			amountWeight = 15
		elseif parseInt(myWeight) >= 45 and parseInt(myWeight) <= 75 then
			amountWeight = 10
		elseif parseInt(myWeight) >= 80 and parseInt(myWeight) <= 115 then
			amountWeight = 5
		-- elseif parseInt(myWeight) >= 100 and parseInt(myWeight) <= 115 then
		-- 	amountWeight = 2
		elseif parseInt(myWeight) >= 120 then
			amountWeight = 1
		end
