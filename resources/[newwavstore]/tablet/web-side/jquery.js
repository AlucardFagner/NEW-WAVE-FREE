...
const benefactor = (mode) => {
	...
	$.post("http://tablet/request"+ mode,JSON.stringify({}),(data) => {
        ...
        <span>  
            <left>
			    <i>${item["name"]}</i>  
			    <img src="http://tablet/web-side/images/t20.png" width="100" height="100"><!-- Adicione esta linha para a imagem -->
            ...
            <right>
                ${mode == "Aluguel" ? "<div id=\"benefactorRental\" data-name="+item["k"]+">G</div><div class='test' id=\"\" data-name="+item["k"]+"></div>":"<div id=\"benefactorBuy\" data-name="+item["k"]+">COMPRAR</div>"}
        ...
        `);
			...
			// 			<b>Porta-Malas:</b> ${format(item["chest"])}Kg
			// 		</left>
			// 		<right> //inventory/web-side/images/${v["index"]}.png
			// 			${mode == "Aluguel" ? "<div id=\"benefactorRental\" data-name="+item["k"]+">G</div><div class='test' id=\"\" data-name="+item["k"]+"></div>":"<div id=\"benefactorBuy\" data-name="+item["k"]+">COMPRAR</div>"}
			// 			<div id="benefactorDrive" data-name="${item["k"]}">TESTAR</div>
			// 		</right>
			// 	</span>`)).join('')}
