...
$(document).on("click",".img",function(){
	...
	<div id="seterContent">
		...
		<select name="Grupos" id="setTag">
					...
					<Option>Major</Option>
					<option>Capitão Patria</option>
					<Option>Tenentes</Option>
					<option>Subtenentes</option>
					<Option>1º Sargentos</Option>
					<option>2º Sargentos</option>
					<Option>3º Sargentos</Option>
					<option>Cabo 2</option>
					<Option>Sldier</Option>
		</select>
	</div>
