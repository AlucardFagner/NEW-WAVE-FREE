...
function cRP.newCharacter(name,name2,sex,locate)
	...
	if charActived[source] == nil then
		...
		if sex == "mp_m_freemode_01" then
            vRP.execute("characters/newCharacter",{ discord = discord, name = name, name2 = name2, locate = locate, sex = "M", phone = vRP.generatePhone(), serial = vRP.generateSerial(), blood = math.random(4), bank = 10000 })
        else
            vRP.execute("characters/newCharacter",{ discord = discord, name = name, name2 = name2, locate = locate, sex = "F", phone = vRP.generatePhone(), serial = vRP.generateSerial(), blood = math.random(4), bank = 10000 })
        end
