...
AddEventHandler("vRP:playerActive",function(user_id,name)
	...
	SetDiscordAppId(1136870799790317638)   -- id rich presence
	SetDiscordRichPresenceAsset("512")   -- nome da logo
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("512")
	SetDiscordRichPresenceAssetText("https://discord.gg/6qKasA3Jgk") --- link do discord
	SetDiscordRichPresenceAssetSmallText("https://discord.gg/6qKasA3Jgk") --- link do discord
	SetDiscordRichPresenceAction(0,"New Wave Store","") --- nome do seu discord ou base
	SetDiscordRichPresenceAction(1,"https://discord.gg/6qKasA3Jgk","https://discord.gg/kHUmZTpTZu") --- link do discord
