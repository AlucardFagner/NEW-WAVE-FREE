...
function vRP.userIdentity(user_id)
	if vRP.userSources[user_id] then
		if vRP.userInfos[user_id] == nil then
			...
			local identityProfissao = vRP.query("playerdata/datatable",{user_id = user_id})
...
function vRP.upgradeChars(user_id)
	vRP.execute("accounts/infosUpdatechars",{ discord = vRP.userInfos[user_id]["discord"] })
...
-- USERGEMSTONE
-----------------------------------------------------------------------------------------------------------------------------------------
function vRP.userGemstone(discord)
...
function vRP.upgradeGemstone(user_id,amount)
	vRP.execute("accounts/infosUpdategems",{ discord = vRP.userInfos[user_id]["discord"], gems = amount })
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- UPGRADENAMES
-----------------------------------------------------------------------------------------------------------------------------------------
